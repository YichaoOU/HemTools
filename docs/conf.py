...
latex_documents = [
    (master_doc, 'HemTools.tex', u'HemTools Documentation',
     u'Yichao Li, Yong Cheng', 'manual'),
]
...
man_pages = [
    (master_doc, 'hemtools', u'HemTools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HemTools', u'HemTools Documentation',
     author, 'HemTools', 'One line description of project.',
     'Miscellaneous'),
]
