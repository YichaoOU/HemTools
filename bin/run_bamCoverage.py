...
def my_args():
	...
	mainParser.add_argument('-f',"--bam_list",  help="tsv 2 columns, bam output",required=True)
	mainParser.add_argument("--addon_parameters",  default="")
	mainParser.add_argument('-b',"--bin_size",  default=50)
	mainParser.add_argument("--center_reads", action='store_true')
...
def main():
	...
	args = my_args()
	if args.center_reads:
		args.addon_parameters += " --center_reads"
