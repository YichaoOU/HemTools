...
def my_args():
	...
	mainParser.add_argument('--max_overlap', help="max_overlap for read merging",default=100,type=int)
	...
	mainParser.add_argument('--queue',  help="which queue to use",default='priority')
