...
def my_args():
	...
	mainParser.add_argument('-q',"--MAPQ",  help="Minimal mapping quality, whether to address multi-mapped reads, set q=0 to consider multi-mapped reads", default=20,type=int)
	...
	genome.add_argument('--database',  help="EricScript database", default=myData['hg19_eric'])
...
def main():
	...
	args = my_args()
	args.database = myData['%s_eric'%(args.genome)]
