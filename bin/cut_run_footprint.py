...
def my_args():
	...
	mainParser.add_argument('-f',"--input_tsv",  help="TSV file, 3 columns, peak, bam, output, need absolute path to file",required=True)
	mainParser.add_argument('-q',"--minMappingQuality",default=2)
	mainParser.add_argument("--maxFragmentLength",default=150)
